...
export const metadata: Metadata = {
  ...
  description:
    "Explore real Missouri hunting properties with LiDAR-powered terrain analysis. See deer movement corridors, funnel zones, and stand placements — then get your own Hunt Report for $49.",
  openGraph: {
    type: "website",
    locale: "en_US",
    url: `${SITE_URL}/demo`,
