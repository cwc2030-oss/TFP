...
const DEMO_PARCELS = [
  ...
  },
  {
    id: "parcel-2",
    slug: "classic-lease",
    label: "Classic Lease — 116 Acres",
    subtitle: "Private Lease Parcel · 116 ac · Saline County",
    address: "Liberty, MO 65351",
    lat: 38.945912,
    lng: -93.263680,
    acreage: 116,
    owner: "DIESEL INVESTMENTS LLC",
    emoji: "🏕️",
    gradient: "from-emerald-600 to-teal-700",
    borderColor: "border-emerald-500/30",
    tags: [
      { text: "Private — permission required", type: "good" as const },
      { text: "Classic lease-sized property", type: "good" as const },
      { text: "Saline County", type: "good" as const },
    ],
  },
  {
    id: "parcel-3",
