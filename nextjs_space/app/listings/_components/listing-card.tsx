/**
 * <ListingCard /> — grid card for the public marketplace.
 *
 * Server component. OPSEC: only renders columns that pass through stripForPublic.
 * Photo is intentionally lazy-loaded.
 */
...
export default function ListingCard({ listing }: { listing: Card }) {
