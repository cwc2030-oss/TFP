...
- Pro Max card: bronze/darker-gold accent (`#8b6b1f` border/bg, `#6b4f14` hover, `#5a4211` deep gradient, `#f5e6b8` text), "Go Pro Max" CTA. Retains "BEST VALUE" badge, "⚡ PRO MAX" header, $199/year or $24/month pricing, 10-parcel Territory Mode + Priority processing features.
