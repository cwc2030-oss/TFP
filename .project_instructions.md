...
- **Proximity falloff steepened**: sextic `(1-t²)³` replaces quartic `(1-t²)²` — much tighter cores
...
- **Focus mode offsets**: Reduced to ±3px (was ±6) so 'broad' mode doesn't re-inflate blobs
