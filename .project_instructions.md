...
- **Onboarding banner**: Dismissible welcome card at top of left panel when `demoMode` is true (`showOnboarding` state). Explains what Demo Mode shows and invites user to explore.
