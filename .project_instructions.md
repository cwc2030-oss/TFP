...
- **Stripe price IDs**: Pro Annual `price_1TM7iXCjOK9CKFruXstxlL2e`, Pro Monthly `price_1TM7lRCjOK9CKFruUtcZBuzA`. Pro Max Annual/Monthly: `STRIPE_PROMAX_ANNUAL_PRICE_ID` / `STRIPE_PROMAX_MONTHLY_PRICE_ID` (PLACEHOLDER — Clark needs to create in Stripe dashboard).
